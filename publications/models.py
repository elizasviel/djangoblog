...
class Publication(models.Model):
    ...
    image = models.ImageField(null=False, blank=False, upload_to='publication_image')
    highResCover = models.ImageField(null=True, blank=True, upload_to='publication_image')
