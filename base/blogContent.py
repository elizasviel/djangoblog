...
def getCareer():
    ...
    for ct in edu:
        ...
        contents += f"""
            <div class="mt-3">
                <p>{ctc.start_year}―{ctc.end_year}</p>
    ...
    for category in categories:
        ...
        for article in articles:
            ...
            for keyword in keywords:
                keywordsTxt += f"{keyword.blogkeyword}, "

            content += f"""
                <div class="col-md-3 col-home-blogs ml-2 mt-2" style="padding: 0;">
                    <a href="articles/details/{article.title}-{article.id}">
                        <img class="card-img-top" note="blog_image" style="height: 325px;" src="{article.image.url}" alt="Card image cap">
                        
                        <h4 class="blog-img">{article.title}</h4>
                ...
                <div class="card mt-3" style="background-color: #000;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4 col-blog-index">
                            <img class="blog-index-img" note="blog_image" src="{article.image.url}" alt="">
                        </div>
                    </div>
                    </div>
                </div>
